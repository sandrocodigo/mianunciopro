...
export class UsuarioService {
  ...
  /*   // OBTENER POR ID (una sola vez)
    async obtenerPorId(ID: string): Promise<any | null> {
      const docRef = doc(this.firestore, `${this.url}`, ID); // Referencia al documento
      try {
        // Usa docData y toma el primer valor con firstValueFrom
  ...
  // OBTENER CONSULTA
  async obtenerConsultaPorTipo(datos: any): Promise<any[]> {
